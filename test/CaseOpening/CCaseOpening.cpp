...
{
	CCaseOpening::vCrates.push_back(CCrate{ "CS:GO Weapon Case", 4001, 1203, 1, {CItem{33, 3, 11}, CItem{8, 3, 73}, CItem{39, 3, 98}, CItem{4, 4, 48}, CItem{61, 4, 60}, CItem{60, 4, 60}, CItem{7, 5, 44}, CItem{1, 5, 61}, CItem{9, 6, 51}, } });
	CCaseOpening::vCrates.push_back(CCrate{ "eSports 2013 Case", 4002, 1204, 1, {CItem{16, 3, 176}, CItem{27, 3, 177}, CItem{10, 3, 178}, CItem{13, 4, 83}, CItem{29, 4, 83}, CItem{36, 4, 162}, CItem{7, 5, 14}, CItem{9, 5, 174}, CItem{19, 6, 156}, } });
	CCaseOpening::vCrates.push_back(CCrate{ "CS:GO Weapon Case 2", 4004, 1203, 1, {CItem{30, 3, 216}, CItem{60, 3, 217}, CItem{10, 3, 218}, CItem{36, 3, 219}, CItem{38, 3, 232}, CItem{3, 4, 44}, CItem{34, 4, 61}, CItem{35, 4, 214}, CItem{2, 4, 220}, CItem{19, 5, 67}, CItem{61, 5, 221}, CItem{40, 6, 222}, } });
	CCaseOpening::vCrates.push_back(CCrate{ "Operation Bravo Case", 4003, 1203, 1, {CItem{39, 3, 186}, CItem{2, 3, 190}, CItem{35, 3, 191}, CItem{13, 3, 192}, CItem{24, 3, 193}, CItem{11, 3, 195}, CItem{61, 4, 183}, CItem{16, 4, 187}, CItem{17, 4, 188}, CItem{60, 4, 189}, CItem{19, 5, 182}, CItem{32, 5, 211}, CItem{9, 5, 212}, CItem{7, 6, 180}, CItem{1, 6, 185}, } });
	CCaseOpening::vCrates.push_back(CCrate{ "eSports 2013 Winter Case", 4005, 1204, 1, {CItem{13, 3, 216}, CItem{3, 3, 223}, CItem{26, 3, 224}, CItem{35, 3, 225}, CItem{11, 3, 229}, CItem{36, 3, 230}, CItem{7, 4, 226}, CItem{19, 4, 228}, CItem{10, 5, 154}, CItem{9, 5, 227}, CItem{1, 5, 231}, CItem{16, 6, 215}, } });
}
